...
For AMD/ATI based systems (Intel/NVIDIA systems are untested) the accelerated parallel processing SDK may be required: http://developer.amd.com/sdks/amdappsdk/pages/default.aspx
